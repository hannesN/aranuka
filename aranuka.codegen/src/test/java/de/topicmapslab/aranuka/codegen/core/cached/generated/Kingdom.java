...
*/
@Association(container_role="http://en.wikipedia.org/wiki/Kingdom", role="http://en.wikipedia.org/wiki/Capital", type="http://en.wikipedia.org/wiki/Country-Capital")
private Set<City> city ;

/*
* field definition for country
*/
@Association(container_role="http://en.wikipedia.org/wiki/Kingdom", role="http://en.wikipedia.org/wiki/Neighbouring_Country", type="http://en.wikipedia.org/wiki/Neighbouring_Countries")
