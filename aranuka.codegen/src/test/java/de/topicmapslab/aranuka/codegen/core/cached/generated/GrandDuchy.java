...
@Topic(name="Grand_duchy", si="http://en.wikipedia.org/wiki/Grand_duchy")
public class GrandDuchy {

private boolean modified = false;

private final org.tmapi.core.Topic topic;

public GrandDuchy(org.tmapi.core.Topic topic){
	this.topic = topic;
}
...
*/
@Association(container_role="http://en.wikipedia.org/wiki/Grand_duchy", role="http://en.wikipedia.org/wiki/Capital", type="http://en.wikipedia.org/wiki/Country-Capital")
private Set<City> city ;

/*
* field definition for country
*/
@Association(container_role="http://en.wikipedia.org/wiki/Grand_duchy", role="http://en.wikipedia.org/wiki/Neighbouring_Country", type="http://en.wikipedia.org/wiki/Neighbouring_Countries")
...
public Set<Kingdom> getKingdom() throws TopicMap2JavaMapperException{
	if ( this.kingdom == null ){
		this.kingdom = (Set<Kingdom>) PropertyLoader.getInstance().getDataBridge().getTraversalPlayers(this.topic,Kingdom.class ,"http://en.wikipedia.org/wiki/Neighbouring_Country" );
	}
	return this.kingdom;
}
