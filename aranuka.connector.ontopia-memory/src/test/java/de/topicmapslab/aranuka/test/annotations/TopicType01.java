...
public class TopicType01 {
	...
	@Occurrence(type="test:long_occurrence")
	private long longOccurrence;
	...
	public void setLongOccurrence(long longOccurrence) {
		this.longOccurrence = longOccurrence;
	}
	public long getLongOccurrence() {
		return longOccurrence;
	}
}
